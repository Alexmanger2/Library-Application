...
public class Library {
	...
	public void yes(Registration reg) {
		...
		// needs to get info from already created user and use that prev user with
		// registration instance...
		// check "no" option to see how its done. Probably need to ask the first/last
		// name and then use gets methods to set
...
//			  }
	...
	public void no(Registration reg) {
		...
		while (true) {
			String answer = "";
			System.out.println(
					"Do you want to take out or return a book?(1: borrow | 2: return | 3: switch user | 4: Exit) ");
			Scanner ans = new Scanner(System.in);
			answer = ans.nextLine();
