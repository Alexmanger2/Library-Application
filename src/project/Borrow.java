	...
	public void init(Person p1, Book b) {
		...
		if (p1.getLateBalance() == 0.0) {
			if (bookCount < 3) {
				...
				p1.setBookList(b);
				System.out.println(p1.getFirstName() + " " + p1.getLastName() + " checked out " + b.getTitle() + " by "
						+ b.getAuthor());
				System.out.println(p1.getFirstName() + " " + p1.getLastName() + " has the following books checked out: "
						+ p1.getBookList() + "\n");
